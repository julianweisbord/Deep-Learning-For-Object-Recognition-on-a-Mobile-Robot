...
class PrepareData():
    ...
    def load_train(self, train_path, object_num, classes, image_size):
        '''
	...
	print('Now going to read {} files (Index: {})'.format(classes, index))
	
	img1 = classes + '_' + str(object_num) 
	path = train_path
	...
	class_name.append(classes)
        ...
        print("class_name: {} labels: {}".format(class_name, labels))
